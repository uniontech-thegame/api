...
router.get('/', function (req, res) {
  ...
  asyncS(() => {
    try {
      ...
      toReturn.availableGifts = {}
      for (let giftLocation of availableGifts) toReturn.availableGifts[giftLocation.location.toLowerCase()] = parseInt(giftLocation.count, 10)
